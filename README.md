...
| **Hardening** | CIS benchmark checks — firewall, FileVault, auto-login, screen lock, SSH (incl. password / root-login policy), sharing services, software updates, Find My Mac, download quarantine, sudo Touch ID, Bluetooth discoverable mode |
