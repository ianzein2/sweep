...
final class EvidenceScanner: Scanner {
    let name = "Evidence Scan"
    ...
    private func scanForStoredScreenshots(home: String, findings: inout [Finding], errors: inout [String], progress: Spinner?) {
    ...
    private func scanForKeystrokeLogs(home: String, findings: inout [Finding], errors: inout [String], progress: Spinner?) {
