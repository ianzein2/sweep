...
| **Supply Chain** | Malicious npm/PyPI packages (2024-2026 takedowns), over-permissive credential dotfiles (`.npmrc`/`.aws/credentials`/`.pypirc`), exposed API keys in Downloads/Desktop/tmp, rogue MCP server configs, global git hooks |
