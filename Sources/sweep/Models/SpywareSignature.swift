...
struct SpywareSignature {
    let name: String
    let processNames: [String]
    let bundleIdentifiers: [String]
    let filePaths: [String]
    let launchAgentLabels: [String]

    // MARK: - Known Spyware Database

    static let known: [SpywareSignature] = [
        // Consumer keyloggers
        SpywareSignature(
            name: "Spyrix",
    ...
    static let fakeAppleBundlePatterns: [String] = [
    ...
    static let suspiciousSystemNames: Set<String> = [
    ...
    static func isFakeAppleBundleId(_ bundleId: String) -> Bool {
    ...
    static func isSuspiciousSystemName(_ name: String) -> Bool {
        return suspiciousSystemNames.contains(name)
    }

    // MARK: - Match Methods

    static var allProcessNames: Set<String> {
    ...
    static func match(processName: String) -> SpywareSignature? {
    ...
    static func match(bundleId: String) -> SpywareSignature? {
        known.first { sig in
            sig.bundleIdentifiers.contains(bundleId)
        }
    }

    static func match(label: String) -> SpywareSignature? {
