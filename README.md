...
| **Persistence** | Scans LaunchAgents, LaunchDaemons, Background Task Management (Ventura+), Application Scripts, login items, StartupItems, rc scripts, shell configs, cron jobs, login/logout hooks, periodic scripts, audit_control tampering |
...
| **Hardening** | CIS benchmark checks — firewall, FileVault, auto-login, screen lock, SSH, sharing services, software updates, AirPlay Receiver, sudo CVE-2025-32463 (chwoot), XProtect Remediator freshness, App Management (Sonoma+) |
