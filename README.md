...
| **Persistence** | Scans LaunchAgents, LaunchDaemons, login items (Ventura+ btm), StartupItems, rc scripts, shell configs, cron jobs, login/logout hooks, periodic scripts, AppleScript handlers, Folder Actions |
...
| **System Integrity** | Verifies SIP, Gatekeeper, XProtect health, Full Disk Access grants, third-party authorization plugins, user-approved kext teams |
...
| **Supply Chain** | Malicious npm postinstall hooks, tampered git hooks, hijacked npm/pip registries, non-official Homebrew taps, ClickFix payloads in shell history, unexpected SUID/SGID binaries |
